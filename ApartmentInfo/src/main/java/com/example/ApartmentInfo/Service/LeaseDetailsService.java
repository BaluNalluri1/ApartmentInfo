...
public class LeaseDetailsService {
   ...
   public LeaseDetailsService(LeaseDetailsRepo leaseDetailsRepo,PropertyUserRepo propertyUserRepo,PropertyRepo propertyRepo) {
    ...
    Propertyuser propertyuser=new Propertyuser(leaseRequestDTO.getUname(),leaseRequestDTO.getUphone(), leaseRequestDTO.getUemail(), leaseRequestDTO.getPassword(),property.getAddress());
