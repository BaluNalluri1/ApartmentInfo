...
public class PropertyuserService {
  ...
  @Transactional
    public void createProperty(PropertyRequestDTO propertyRequestDTO) {
     ...
     Propertyuser owner=new Propertyuser(propertyRequestDTO.getUname(),propertyRequestDTO.getUemail(),propertyRequestDTO.getUphone(),propertyRequestDTO.getPassword(),address);
